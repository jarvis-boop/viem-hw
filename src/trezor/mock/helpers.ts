...
import type { Address, Hex as HexType, SignableMessage, TransactionSerializable, TypedDataDefinition, LocalAccount } from 'viem'
 ...
 * ```
 */
export function createMockTrezorDiscovery(options: {
  count?: number
  startIndex?: number
  basePath?: string
